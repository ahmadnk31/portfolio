    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hello! I&apos;m Ahmadullah Nekzad, a passionate full-stack developer
          and writer with a love for crafting exceptional digital experiences.
          My journey in the tech world has been a thrilling adventure, and I
